...
public class DBforAnalysis extends SQLiteOpenHelper{
    ...
    //DB Data add
    public void addMenu(String name, String price, String cost, byte[] image){
        SQLiteDatabase db;
    ...
    public void addOrder(Order order){
        ...
        sb.append(" ORDER_AMOUNT, ORDER_DATE, ORDER_TIME, ORDER_NUMBER, ORDER_FK_MENUID, ORDER_MENU_PRICE )");
        sb.append(" VALUES (?, ?, ?, ?, ?, ?); ");
    ...
    public ArrayList<Order> getAllOrderData(){
        ...
        StringBuffer sb = new StringBuffer();
        sb.append(" SELECT ORDER_AMOUNT, ORDER_DATE, ORDER_TIME, ORDER_NUMBER, ORDER_FK_MENUID, ORDER_MENU_PRICE FROM ORDER_TABLE ");
